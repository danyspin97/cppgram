...
void cppgram::CoreBot::sendMessage(const string& id, const string& text,  ParseMode parse_mode, bool disable_web_page_preview, bool disable_notification, cppgram::uid_32 reply_to_message_id, void* reply_markup)
{
