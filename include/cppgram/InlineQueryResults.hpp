#ifndef CPPGRAM_INLINEQUERYRESULT_HPP
#define CPPGRAM_INLINEQUERYRESULT_HPP
...
public:
     ...
     * @param reply_markup <i>Optional</i>. Inline keyboard attached to the message
     * @param description <i>Optional</i>. Short description of the result
     * @param parse_mode Optional. Formatting option
     * @param disable_web_page_preview <i>Optional</i>. Disables link previews for links in the sent message
