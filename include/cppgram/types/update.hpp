...
class Update
{
        ...
        : update_id( json_update["update_id"].asUInt() )
    {
        ...
        else if ( !json_update["channel_post"].isNull() )
        {
            type = EUpdate::eChannelPost;
            message.emplace( Message( json_update["channel_post"] ) );
        }
        ...
        else if ( !json_update["edited_message"].isNull() )
        {
            ...
            message.emplace( Message( json_update["edited_message"] ) );
        }
        else if ( !json_update["edited_channel_post"].isNull() )
        {
            type = EUpdate::eEditedChannelPost;
            message.emplace( Message( json_update["edited_channel_post"] ) );
        }
