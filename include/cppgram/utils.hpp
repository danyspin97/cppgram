...
split( const std::string &str, const char &splchr );
/*!
 ...
 */
const std::string
getTime( const std::string &timeformat = "%a %F %r" );
/*!
 ...
 */
void
log( const Log &logType, const std::string &message, const std::string &filename = "tg_bot.log" );
